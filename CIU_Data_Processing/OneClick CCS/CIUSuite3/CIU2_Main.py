...
from CIUSuite3.CIU_analysis_obj import CIUAnalysisObj
import CIUSuite3.CIU_Params as CIU_Params
import CIUSuite3.Raw_Processing as Raw_Processing
import CIUSuite3.Original_CIU as Original_CIU
import CIUSuite3.Gaussian_Fitting as Gaussian_Fitting
import CIUSuite3.Feature_Detection as Feature_Detection
import CIUSuite3.Classification as Classification
import CIUSuite3.Raw_Data_Import as Raw_Data_Import
import CIUSuite3.SimpleToolTip as SimpleToolTip
import CIUSuite3.Multi_Dimensional_Preprocessing as mdp
from CIUSuite3.Signal_Cutoff import signal_cutoff_main
from CIUSuite3.peakpicking_mz import peakpicking_main
from CIUSuite3.SIU_CV_Correction import CV_correction_main
from CIUSuite3.DTIM_CCS_calibration import DTIM_CCS_calibration_main
...
class CIUSuite2(object):
    ...
    def load_raw_files(self, raw_filepaths):
        ...
        if len(raw_filepaths) > 0:
            ...
            if param_success:
                ...
                self.analysis_file_list = analysis_filenames
    ...
    def on_button_oldplot_clicked(self):
        ...
        """
        self.params_obj.plot_10_y_title = 'Collision Cross Section (Å$^2$)'
    ...
    def on_button_gaussfit_clicked(self, polya_expected_peaks, polya_num_cores, polya_dt_tolerance):
        """
        ...
        if t1_param_success:
            ...
            t2_param_dict['gaussian_71_max_prot_components'] = polya_expected_peaks
            t2_param_dict['gaussian_61_num_cores'] = polya_num_cores
            self.params_obj.gaussian_71_max_prot_components = polya_expected_peaks
            self.params_obj.gaussian_73_prot_width_tol = polya_dt_tolerance
            self.params_obj.gaussian_61_num_cores = polya_num_cores
            # print(t2_param_success, t2_param_dict, flush=True)
            if t2_param_success:
                # Determine if a file range has been specified
                files_to_read = self.check_file_range_entries()
                # self.progress_started()
    ...
    def on_button_feature_detect_clicked(self, min_feature_length, min_feature_width_tolerance):
        """
        Run feature detection routine.
        :return: void
        """
        
        self.params_obj.feature_t2_1_min_length = min_feature_length
        self.params_obj.feature_t2_2_width_tol = min_feature_width_tolerance
